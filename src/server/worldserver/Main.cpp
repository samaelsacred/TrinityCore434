...
char serviceName[] = "World of Warcraft Server";
char serviceLongName[] = "World of Warcraft World Emulator";
char serviceDescription[] = "a World of Warcraft world emulator";
/*
...
extern int main(int argc, char **argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "Main Kernel loaded succesfully, proceeding :)", ACE_VERSION);
}
