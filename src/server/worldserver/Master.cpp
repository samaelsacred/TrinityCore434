...
int Master::Run()
{
    ...
    TC_LOG_INFO("server.worldserver", "TwilightCore, a World of Warcraft 4.3.4 (15595) emulator.");
	TC_LOG_INFO("server.worldserver", "Valhalla 4.3.4 | www.valhallaservers.net");
